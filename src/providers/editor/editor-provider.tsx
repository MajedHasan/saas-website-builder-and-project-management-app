...
const editorReducer = (
  ...
  switch (action.type) {
    ...
    case "UPDATE_ELEMENT":
      ...
      const updatedElementsIsSelected =
        state.editor.selectedElement.id === action.payload.elementDetails.id;

      const updatedEditorStateWithUpdate = {
        ...state.editor,
        elements: updatedElements,
        selectedElements: updatedElementsIsSelected
...
const EditorProvider = (props: EditorPorps) => {
...
export const useEditor = () => {
  ...
  if (!context) {
    throw new Error("use Editor Hook Must be within a editor Provider");
  }
  return context;
};
